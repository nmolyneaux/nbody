...
\begin{tikzpicture}  
  ...
  \filldraw[blue!60!white, draw=black] (6.8,-0.3) rectangle (9.2,0.3);
  \filldraw[red!80!black, draw=black] (9.2,-0.3) rectangle (9.5,0.3);
  % proc 1
  ...
  \filldraw[red!80!black, draw=black] (9.2,-1.3) rectangle (9.5,-0.7);
  % proc 2
  ...
  \filldraw[red!80!black, draw=black] (9.2,-2.3) rectangle (9.5,-1.7);
  % proc 3
  ...
  \filldraw[red!80!black, draw=black] (9.2,-3.3) rectangle (9.5, -2.7);

  \draw[red, dashed, thick] (6.8,-3.4) rectangle (9.5, 0.4);
  \draw [red,decorate,decoration={brace,amplitude=8pt}] (6.8, 0.45) -- node [pos=0.5, midway, yshift=0.5cm] {repeated $\frac{t_{max}}{dt}$ times} (9.5,0.45);

  \draw[->, thick] (-0.7, -3.5) -- (10.0,-3.5) node[xshift=0.5cm] {$t$};
  % legend
