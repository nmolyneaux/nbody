...
\begin{tikzpicture}
  ...
  \draw (5,1) rectangle (10,2) node[draw,circle,inner sep=1pt,pos=0.5] {\textbf{B}};
  \node (topEnd) at (10,1) {};
  \node (topStart) at (7,1) {};
  \node (topMiddleStart) at (5,1.5) {};
  \node (topMiddleEnd) at (10,1.5) {};

  \draw (5,-1) rectangle (10,-2) node[draw,circle,inner sep=1pt,pos=0.5] {\textbf{B}};
  \node (bottomEnd) at (10,-1) {};
  \node (bottomStart) at (7,-1) {};
  \node (bottomMiddleStart) at (5,-1.5) {};
  \node (bottomMiddleEnd) at (10,-1.5) {};
  ...
  \draw (10,1) rectangle (12,2) node[draw,circle,inner sep=1pt,pos=0.5] {\textbf{C}};
  ...
  \node[draw,circle,inner sep=1pt] (splitLabel) at (8.5,-0.3) {\textbf{2}};
  ...
  \node[right] at (0.7,-4.0) {- Main node writes the data to file};
